...
public static class UsersEndpoints
{
    ...
    private static async Task<Results<Ok<AuthenticationResponseDTO>,
    ...
    private static async Task<Results<Ok<AuthenticationResponseDTO>, BadRequest<string>>> Login(
    ...
    private static async Task<Results<NoContent, NotFound>> MakeAdmin(EditClaimDTO editClaimDTO,
        [FromServices] UserManager<IdentityUser> userManager)
    {
    ...
    private static async Task<Results<NoContent, NotFound>> RemoveAdmin(EditClaimDTO editClaimDTO,
        [FromServices] UserManager<IdentityUser> userManager)
    {
        var user = await userManager.FindByEmailAsync(editClaimDTO.Email);
    ...
    private static async Task<AuthenticationResponseDTO>
